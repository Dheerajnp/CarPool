...
export default function RideDetailsPage() {
  ...
  // Set OTP if the ride is active and the current user is a passenger
          ...
          <Card className="w-full max-w-3xl mx-auto">
            ...
            <CardContent>
              <div className="grid gap-6">
                ...
                <div className="flex items-center gap-2">
                  {otp && (
                    <Badge className="h-auto w-auto p-2 bg-green-600 hover:bg-green-500">
                      <span className="text-[16px]">OTP: {otp}</span>
                    </Badge>
                  )}
                </div>
                    ...
                    <div className="flex justify-between">
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="text-lg">
                          {" "}
                          Total : ₹{" "}
                          {rideData.price * passenger.numberOfPassengers}
                        </div>
                      </div>
                      <div>
